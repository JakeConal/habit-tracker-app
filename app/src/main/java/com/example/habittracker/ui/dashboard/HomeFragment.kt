...
/**
 * HomeFragment - Màn hình chính hiển thị dashboard của ứng dụng
...
class HomeFragment : Fragment() {
    ...
    private fun setupView() {
        // TODO: Setup dashboard UI components
        // - Hiển thị danh sách habits hôm nay
        // - Hiển thị progress overview
