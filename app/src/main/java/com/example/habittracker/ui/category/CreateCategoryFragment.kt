...
class CreateCategoryFragment : Fragment() {
    ...
    private fun createCategory() {
        ...
        // Send the new category data back to CategoryFragment
        setFragmentResult(
            "new_category_request_key",
            bundleOf(
                "category_name" to categoryTitle,
                "category_icon" to selectedIconRes,
                "category_background" to selectedColorRes
            )
        )
